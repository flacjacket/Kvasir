...
namespace Register
{
    ...
    namespace Detail
    {
        ...
        struct MergeRegisterActions<
            brigand::list<Action<FieldLocation<TAddress, Mask1, TAccess1, TFieldType1>,
                                 TActionTemplate<Value1>>,
                          Ts...>,
            brigand::list<Action<FieldLocation<TAddress, Mask2, TAccess2, TFieldType2>,
                                 TActionTemplate<Value2>>,
                          Us...>>
            : MergeRegisterActions<
                  brigand::list<Ts...>,
        ...
        template <typename... Ts>
        using GetReturnType =
            FieldTuple<UniqueT<brigand::sort<
                           brigand::transform<GetReadsT<Ts...>, brigand::quote<GetAddress>>>>,
                       GetReadsT<Ts...>>;
        template <typename T>
