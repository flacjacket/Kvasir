...
template <unsigned A, unsigned WriteIgnoredIfZeroMask = 0, unsigned WriteIgnoredIfOneMask = 0,
          typename TRegType = unsigned, typename TMode = NormalMode>
struct Address
{
...
template <AccessType, ReadActionType = ReadActionType::normal,
...
template <typename TAddress, unsigned Mask, typename Access = ReadWriteAccess,
...
struct FieldValue
{
    ...
    operator typename TFieldLocation::DataType() const { return Value; }
};
                  ...
                  brigand::list<FieldLocation<TAs, Masks, TAccesss, TRs>...>>
{
    ...
    brigand::at_c<brigand::list<TRs...>, Index> get() const
    {
        ...
        constexpr unsigned index =
            sizeof...(Is) - brigand::size<brigand::find<brigand::list<brigand::uint32_t<Is>...>,
    ...
    using ConvertableTo =
        typename std::conditional<(sizeof...(TRs) == 1), brigand::at_c<brigand::list<TRs...>, 0>,
                                  DoNotUse>::type;
