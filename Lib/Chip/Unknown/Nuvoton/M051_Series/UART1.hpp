...
namespace Kvasir {
//Registers group
    namespace Uart1UaRbr{    ///<UART0 Receive Buffer Register.
    ...
    namespace Uart1UaThr{    ///<UART0 Transmit Holding Register.
        using Addr = Register::Address<0x40150000,0xffffff00,0x00000000,unsigned>;
    ...
    namespace Uart1UaIer{    ///<UART0 Interrupt Enable Register.
    ...
    namespace Uart1UaFcr{    ///<UART0 FIFO Control Register.
    ...
    namespace Uart1UaMcr{    ///<UART0 Modem Control Register.
    ...
    namespace Uart1UaMsr{    ///<UART0 Modem Status Register.
    ...
    namespace Uart1UaFsr{    ///<UART0 FIFO Status Register.
    ...
    namespace Uart1UaIsr{    ///<UART0 Interrupt Status Register.
        using Addr = Register::Address<0x4015001c,0xffffc0c0,0x00000000,unsigned>;
    ...
    namespace Uart1UaTor{    ///<UART0 Time Out Register
        using Addr = Register::Address<0x40150020,0xffffff80,0x00000000,unsigned>;
    ...
    namespace Uart1UaBaud{    ///<UART0 Baud Rate Divisor Register
        using Addr = Register::Address<0x40150024,0xffffffff,0x00000000,unsigned>;
    ...
    namespace Uart1UaIrcr{    ///<UART0 IrDA Control Register.
        using Addr = Register::Address<0x40150028,0xffffffff,0x00000000,unsigned>;
    ...
    namespace Uart1UaActCsr{    ///<UART0 RS485 Control State Register.
    ...
    namespace Uart1UaFunSel{    ///<UART0 Function Select Register.
