...
namespace Kvasir {
//Registers group
    namespace PwmaPpr{    ///<PWM Pre-scalar Register
    ...
    namespace PwmaCcr0{    ///<Capture Control Register
        using Addr = Register::Address<0x40040050,0xfff0fff0,0x00000000,unsigned>;
    ...
    namespace PwmaCcr2{    ///<Capture Control Register
        using Addr = Register::Address<0x40040054,0xfff0fff0,0x00000000,unsigned>;
    ...
    namespace PwmaPoe{    ///<PWM Output Enable
