...
namespace Kvasir {
//Registers group
    namespace Tmr2Tcsr{    ///<Timer0 Control and Status Register
        using Addr = Register::Address<0x40110000,0x81feff00,0x00000000,unsigned>;
    ...
    namespace Tmr2Tcmpr{    ///<Timer0 Compare Register
        using Addr = Register::Address<0x40110004,0xff000000,0x00000000,unsigned>;
    ...
    namespace Tmr2Tisr{    ///<Timer0 Interrupt Status Register
        using Addr = Register::Address<0x40110008,0xffffffff,0x00000000,unsigned>;
    ...
    namespace Tmr2Tdr{    ///<Timer0 Data Register
        using Addr = Register::Address<0x4011000c,0xff000000,0x00000000,unsigned>;
