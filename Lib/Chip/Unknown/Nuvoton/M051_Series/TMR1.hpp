...
namespace Kvasir {
//Registers group
    namespace Tmr1Tcsr{    ///<Timer0 Control and Status Register
        using Addr = Register::Address<0x40010020,0x81feff00,0x00000000,unsigned>;
    ...
    namespace Tmr1Tcmpr{    ///<Timer0 Compare Register
        using Addr = Register::Address<0x40010024,0xff000000,0x00000000,unsigned>;
    ...
    namespace Tmr1Tisr{    ///<Timer0 Interrupt Status Register
        using Addr = Register::Address<0x40010028,0xffffffff,0x00000000,unsigned>;
    ...
    namespace Tmr1Tdr{    ///<Timer0 Data Register
        using Addr = Register::Address<0x4001002c,0xff000000,0x00000000,unsigned>;
