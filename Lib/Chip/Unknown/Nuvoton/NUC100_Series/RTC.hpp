...
namespace Kvasir {
//Registers group
    namespace RtcInir{    ///<RTC Initiation Register
        using Addr = Register::Address<0x40008000,0x00000000,0x00000000,unsigned>;
        ///RTC Active Status (Read only), 0: RTC is at reset state1: RTC is at normal active state.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> active{}; 
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::Access<Register::AccessType::writeOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> inir{}; 
    }
    namespace RtcAer{    ///<RTC Access Enable Register
    ...
    namespace RtcTlr{    ///<Time Loading Register
        using Addr = Register::Address<0x4000800c,0xffc08080,0x00000000,unsigned>;
    ...
    namespace RtcClr{    ///<Calendar Loading Register
        using Addr = Register::Address<0x40008010,0xff00e0c0,0x00000000,unsigned>;
    ...
    namespace RtcTar{    ///<Time Alarm Register
        using Addr = Register::Address<0x4000801c,0xffc08080,0x00000000,unsigned>;
    ...
    namespace RtcCar{    ///<Calendar Alarm Register
        using Addr = Register::Address<0x40008020,0xff00e0c0,0x00000000,unsigned>;
    ...
    namespace RtcLir{    ///<RTC Leap year Indicator Register
        using Addr = Register::Address<0x40008024,0xfffffffe,0x00000000,unsigned>;
        ///Leap Year Indication REGISTER (Real only).1 = It indicate that this year is leap year0 = It indicate that this year is not a leap year
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> lir{}; 
    }
    namespace RtcRier{    ///<RTC Interrupt Enable Register
        using Addr = Register::Address<0x40008028,0xfffffffc,0x00000000,unsigned>;
        ///Alarm Interrupt Enable1 = RTC Alarm Interrupt is enabled0 = RTC Alarm Interrupt is disabled
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> aier{}; 
        ///Time Tick Interrupt Enable1 = RTC Time Tick Interrupt is enabled0 = RTC Time Tick Interrupt is disabled
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> tier{}; 
    }
    namespace RtcRiir{    ///<RTC Interrupt Indicator Register
        using Addr = Register::Address<0x4000802c,0xffffffff,0x00000000,unsigned>;
        ///RTC Alarm Interrupt FlagWhen RTC Alarm Interrupt is enabled (RIER.AIER=1), RTC controller will set AIF to high once the RTC real time counters TLR and CLR reach the alarm setting time registers TAR and CAR. This bit is software clear by writing 1 to it.1 = Indicates RTC Alarm Interrupt is requested if RIER.AIER=1.0 = Indicates RTC Alarm Interrupt condition never occurred.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::Access<Register::AccessType::readWrite,Register::ReadActionType::normal,Register::ModifiedWriteValueType::oneToClear>,unsigned> aif{}; 
        ///RTC Time Tick Interrupt FlagWhen RTC Time Tick Interrupt is enabled (RIER.TIER=1), RTC controller will set TIF to high periodically in the period selected by TTR[2:0]. This bit is software clear by writing 1 to it.1 = Indicates RTC Time Tick Interrupt is requested if RIER.TIER=1.0 = Indicates RTC Time Tick Interrupt condition never occurred.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::Access<Register::AccessType::readWrite,Register::ReadActionType::normal,Register::ModifiedWriteValueType::oneToClear>,unsigned> tif{}; 
    }
