...
namespace Kvasir {
//Registers group
    namespace Uart0UaRbr{    ///<Receive Buffer Register.
    ...
    namespace Uart0UaThr{    ///<Transmit Holding Register.
        using Addr = Register::Address<0x40050000,0xffffff00,0x00000000,unsigned>;
    ...
    namespace Uart0UaIer{    ///<Interrupt Enable Register.
    ...
    namespace Uart0UaFcr{    ///<FIFO Control Register.
    ...
    namespace Uart0UaLcr{    ///<Line Control Register.
        using Addr = Register::Address<0x4005000c,0xfffffff7,0x00000000,unsigned>;
    ...
    namespace Uart0UaMcr{    ///<Modem Control Register.
    ...
    namespace Uart0UaMsr{    ///<Modem Status Register.
    ...
    namespace Uart0UaFsr{    ///<FIFO Status Register.
    ...
    namespace Uart0UaIsr{    ///<Interrupt Status Register.
        using Addr = Register::Address<0x4005001c,0x43434040,0x00000000,unsigned>;
    ...
    namespace Uart0UaTor{    ///<Time Out Register
        using Addr = Register::Address<0x40050020,0xffffffff,0x00000000,unsigned>;
    ...
    namespace Uart0UaBaud{    ///<Baud Rate Divisor Register
        using Addr = Register::Address<0x40050024,0xc0ffffff,0x00000000,unsigned>;
    ...
    namespace Uart0UaIrcr{    ///<IrDA Control Register.
        using Addr = Register::Address<0x40050028,0xffffffbf,0x00000040,unsigned>;
    ...
    namespace Uart0UaAltCsr{    ///<LIN Break Failed Count Register.
    ...
    namespace Uart0UaFunSel{    ///<Function Select Register.
