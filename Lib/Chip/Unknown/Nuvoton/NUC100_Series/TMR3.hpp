...
namespace Kvasir {
//Registers group
    namespace Tmr3Tcsr{    ///<Timer0 Control and Status Register
        using Addr = Register::Address<0x40110020,0x80feff00,0x00000000,unsigned>;
    ...
    namespace Tmr3Tcmpr{    ///<Timer0 Compare Register
        using Addr = Register::Address<0x40110024,0xff000000,0x00000000,unsigned>;
    ...
    namespace Tmr3Tisr{    ///<Timer0 Interrupt Status Register
        using Addr = Register::Address<0x40110028,0xffffffff,0x00000000,unsigned>;
    ...
    namespace Tmr3Tdr{    ///<Timer0 Data Register
        using Addr = Register::Address<0x4011002c,0xff000000,0x00000000,unsigned>;
