...
namespace Kvasir {
//Registers group
    namespace Uart1UaRbr{    ///<Receive Buffer Register.
        using Addr = Register::Address<0x40150000,0xffffff00,0x00000000,unsigned>;
    ...
    namespace Uart1UaThr{    ///<Transmit Holding Register.
        using Addr = Register::Address<0x40150000,0xffffff00,0x00000000,unsigned>;
    ...
    namespace Uart1UaIer{    ///<Interrupt Enable Register.
        using Addr = Register::Address<0x40150004,0xffffffff,0x00000000,unsigned>;
    ...
    namespace Uart1UaFcr{    ///<FIFO Control Register.
        using Addr = Register::Address<0x40150008,0xffffffff,0x00000000,unsigned>;
    ...
    namespace Uart1UaLcr{    ///<Line Control Register.
        using Addr = Register::Address<0x4015000c,0xfffffff7,0x00000000,unsigned>;
    ...
    namespace Uart1UaMcr{    ///<Modem Control Register.
        using Addr = Register::Address<0x40150010,0xffffdfff,0x00000000,unsigned>;
    ...
    namespace Uart1UaMsr{    ///<Modem Status Register.
        using Addr = Register::Address<0x40150014,0xffffffef,0x00000000,unsigned>;
    ...
    namespace Uart1UaFsr{    ///<FIFO Status Register.
        using Addr = Register::Address<0x40150018,0xee000086,0x00000000,unsigned>;
    ...
    namespace Uart1UaIsr{    ///<Interrupt Status Register.
        using Addr = Register::Address<0x4015001c,0x43434040,0x00000000,unsigned>;
    ...
    namespace Uart1UaTor{    ///<Time Out Register
        using Addr = Register::Address<0x40150020,0xffffffff,0x00000000,unsigned>;
    ...
    namespace Uart1UaBaud{    ///<Baud Rate Divisor Register
        using Addr = Register::Address<0x40150024,0xc0ffffff,0x00000000,unsigned>;
    ...
    namespace Uart1UaIrcr{    ///<IrDA Control Register.
        using Addr = Register::Address<0x40150028,0xffffffbf,0x00000040,unsigned>;
    ...
    namespace Uart1UaAltCsr{    ///<LIN Break Failed Count Register.
        using Addr = Register::Address<0x4015002c,0xffffffff,0x00000000,unsigned>;
    ...
    namespace Uart1UaFunSel{    ///<Function Select Register.
        using Addr = Register::Address<0x40150030,0xffffffff,0x00000000,unsigned>;
