...
namespace Kvasir {
//USART2
    namespace Usart2Cfg{    ///<USART Configuration register. Basic USART configuration settings                        that typically are not changed during operation.
        ...
        enum class Mode32kVal {
            disabled=0x00000000,     ///<Disabled. USART uses standard                                        clocking.
            enabled=0x00000001,     ///<Enabled. USART uses the 32 kHz clock from the RTC                                        oscillator as the clock source to the BRG, and uses a                                        special bit clocking scheme.
        };
        ...
        namespace Mode32kValC{
            constexpr Register::FieldValue<decltype(mode32k)::Type,Mode32kVal::disabled> disabled{};
            constexpr Register::FieldValue<decltype(mode32k)::Type,Mode32kVal::enabled> enabled{};
        }
        ///LIN break mode enable.
        enum class LinmodeVal {
            disabled=0x00000000,     ///<Disabled. Break detect and generate is configured                                        for normal operation.
            enabled=0x00000001,     ///<Enabled. Break detect and generate is configured                                        for LIN bus operation.
        };
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(8,8),Register::ReadWriteAccess,LinmodeVal> linmode{}; 
        namespace LinmodeValC{
            constexpr Register::FieldValue<decltype(linmode)::Type,LinmodeVal::disabled> disabled{};
            constexpr Register::FieldValue<decltype(linmode)::Type,LinmodeVal::enabled> enabled{};
        }
        ...
        enum class SyncenVal {
            asynchronousMode=0x00000000,     ///<Asynchronous mode.
            synchronousMode=0x00000001,     ///<Synchronous mode.
        };
        ...
        namespace SyncenValC{
            constexpr Register::FieldValue<decltype(syncen)::Type,SyncenVal::asynchronousMode> asynchronousMode{};
            constexpr Register::FieldValue<decltype(syncen)::Type,SyncenVal::synchronousMode> synchronousMode{};
        }
        ...
        ///I/O output mode.
        enum class IomodeVal {
            standard=0x00000000,     ///<Standard. USART output and input operate in                                        standard fashion.
            irda=0x00000001,     ///<IrDA. USART output and input operate in IrDA                                        mode.
        };
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(16,16),Register::ReadWriteAccess,IomodeVal> iomode{}; 
        namespace IomodeValC{
            constexpr Register::FieldValue<decltype(iomode)::Type,IomodeVal::standard> standard{};
            constexpr Register::FieldValue<decltype(iomode)::Type,IomodeVal::irda> irda{};
        }
        ///Reserved. Read value is undefined, only zero should be                                written.
        ...
        enum class OetaVal {
            ...
            enabled=0x00000001,     ///<Enabled. If selected by OESEL, the Output Enable                                        signal remains asserted for one character time after the end                                        of the last stop bit of a transmission. OE will also remain                                        asserted if another transmit begins before it is                                        deasserted.
        };
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(18,18),Register::ReadWriteAccess,OetaVal> oeta{}; 
        namespace OetaValC{
            constexpr Register::FieldValue<decltype(oeta)::Type,OetaVal::disabled> disabled{};
            constexpr Register::FieldValue<decltype(oeta)::Type,OetaVal::enabled> enabled{};
        }
        ...
        enum class OeselVal {
            standard=0x00000000,     ///<Standard. The RTS signal is used as the standard                                        flow control function.
            rs485=0x00000001,     ///<RS-485. The RTS signal configured to provide an                                        output enable signal to control an RS-485                                        transceiver.
        };
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(20,20),Register::ReadWriteAccess,OeselVal> oesel{}; 
        namespace OeselValC{
            constexpr Register::FieldValue<decltype(oesel)::Type,OeselVal::standard> standard{};
            constexpr Register::FieldValue<decltype(oesel)::Type,OeselVal::rs485> rs485{};
        }
        ...
        enum class RxpolVal {
            standard=0x00000000,     ///<Standard. The RX signal is used as it arrives from                                        the pin. This means that the RX rest value is 1, start bit                                        is 0, data is not inverted, and the stop bit is                                        1.
            inverted=0x00000001,     ///<Inverted. The RX signal is inverted before being                                        used by the USART. This means that the RX rest value is 0,                                        start bit is 1, data is inverted, and the stop bit is                                        0.
        };
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(22,22),Register::ReadWriteAccess,RxpolVal> rxpol{}; 
        namespace RxpolValC{
            constexpr Register::FieldValue<decltype(rxpol)::Type,RxpolVal::standard> standard{};
            constexpr Register::FieldValue<decltype(rxpol)::Type,RxpolVal::inverted> inverted{};
        }
        ///Transmit data polarity.
        enum class TxpolVal {
            standard=0x00000000,     ///<Standard. The TX signal is sent out without change.                                        This means that the TX rest value is 1, start bit is 0, data                                        is not inverted, and the stop bit is 1.
            inverted=0x00000001,     ///<Inverted. The TX signal is inverted by the USART                                        before being sent out. This means that the TX rest value is                                        0, start bit is 1, data is inverted, and the stop bit is                                        0.
        };
    ...
    namespace Usart2Ctl{    ///<USART Control register. USART control settings that are more likely                        to change during operation.
        ...
        enum class TxbrkenVal {
            normalOperation=0x00000000,     ///<Normal operation.
            continuousBreak=0x00000001,     ///<Continuous break. Continuous break is sent                                        immediately when this bit is set, and remains until this bit                                        is cleared. A break may be sent without danger of corrupting                                        any currently transmitting character if the transmitter is                                        first disabled (TXDIS in CTL is set) and then waiting for                                        the transmitter to be disabled (TXDISINT in STAT = 1) before                                        writing 1 to TXBRKEN.
        };
        ...
        namespace TxbrkenValC{
            ...
            constexpr Register::FieldValue<decltype(txbrken)::Type,TxbrkenVal::continuousBreak> continuousBreak{};
        }
        ...
        enum class ClrcconrxVal {
            noEffect=0x00000000,     ///<No effect. No effect on the CC bit.
        ...
        enum class AutobaudVal {
            disabled=0x00000000,     ///<Disabled. USART is in normal operating                                        mode.
            enabled=0x00000001,     ///<Enabled. USART is in autobaud mode. This bit should                                        only be set when the USART receiver is idle. The first start                                        bit of RX is measured and used the update the BRG register                                        to match the received data rate. AUTOBAUD is cleared once                                        this process is complete, or if there is an                                        AERR.
        };
    ...
    namespace Usart2Stat{    ///<USART Status register. The complete status value can be read here.                        Writing ones clears some bits in the register. Some bits can be cleared by                        writing a 1 to them.
    ...
    namespace Usart2Intenset{    ///<Interrupt Enable read and Set register. Contains an individual                        interrupt enable bit for each potential USART interrupt. A complete value                        may be read from this register. Writing a 1 to any implemented bit position                        causes that bit to be set.
        using Addr = Register::Address<0x4008c00c,0x00000000,0x00000000,unsigned>;
        ...
        ///When 1, enables an interrupt when noise is detected. See                                description of the RXNOISEINT bit in Table 311.
    ...
    namespace Usart2Intenclr{    ///<Interrupt Enable Clear register. Allows clearing any combination of                        bits in the INTENSET register. Writing a 1 to any implemented bit position                        causes the corresponding bit to be cleared.
        using Addr = Register::Address<0x4008c010,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usart2Rxdat{    ///<Receiver Data register. Contains the last character                        received.
        using Addr = Register::Address<0x4008c014,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usart2Rxdatstat{    ///<Receiver Data with Status register. Combines the last character                        received with the current USART receive status. Allows DMA or software to                        recover incoming data and status together.
        using Addr = Register::Address<0x4008c018,0x00000000,0x00000000,unsigned>;
        ///The USART Receiver Data register contains the next received                                character. The number of bits that are relevant depends on the USART                                configuration settings.
        ...
        ///Received Noise flag. See description of the RxNoiseInt bit                                in Table 311.
    ...
    namespace Usart2Txdat{    ///<Transmit Data register. Data to be transmitted is written                        here.
        using Addr = Register::Address<0x4008c01c,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usart2Brg{    ///<Baud Rate Generator register. 16-bit integer baud rate divisor                        value.
        using Addr = Register::Address<0x4008c020,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usart2Intstat{    ///<Interrupt status register. Reflects interrupts that are currently                        enabled.
        using Addr = Register::Address<0x4008c024,0x00000000,0x00000000,unsigned>;
        ///Receiver Ready flag.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> rxrdy{}; 
        ///Reserved. Read value is undefined, only zero should be                                written.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> reserved{}; 
    ...
    namespace Usart2Osr{    ///<Oversample selection register for asynchronous                        communication.
        using Addr = Register::Address<0x4008c028,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usart2Addr{    ///<Address register for automatic address matching.
        using Addr = Register::Address<0x4008c02c,0x00000000,0x00000000,unsigned>;
