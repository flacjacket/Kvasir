...
namespace Kvasir {
//I2C-bus interface 2
    namespace I2c2Cfg{    ///<Configuration for shared functions.
        using Addr = Register::Address<0x4009c000,0x00000000,0x00000000,unsigned>;
    ...
    namespace I2c2Stat{    ///<Status register for Master, Slave, and Monitor                        functions.
        using Addr = Register::Address<0x4009c004,0x00000000,0x00000000,unsigned>;
    ...
    namespace I2c2Intenset{    ///<Interrupt Enable Set and read register.
        using Addr = Register::Address<0x4009c008,0x00000000,0x00000000,unsigned>;
    ...
    namespace I2c2Intenclr{    ///<Interrupt Enable Clear register.
        using Addr = Register::Address<0x4009c00c,0x00000000,0x00000000,unsigned>;
    ...
    namespace I2c2Timeout{    ///<Time-out value register.
        using Addr = Register::Address<0x4009c010,0x00000000,0x00000000,unsigned>;
    ...
    namespace I2c2Clkdiv{    ///<Clock pre-divider for the entire I2C block. This determines what                        time increments are used for the MSTTIME register, and controls some timing                        of the Slave function.
        using Addr = Register::Address<0x4009c014,0x00000000,0x00000000,unsigned>;
    ...
    namespace I2c2Intstat{    ///<Interrupt Status register for Master, Slave, and Monitor                        functions.
        using Addr = Register::Address<0x4009c018,0x00000000,0x00000000,unsigned>;
        ///Master Pending.
    ...
    namespace I2c2Mstctl{    ///<Master control register.
        using Addr = Register::Address<0x4009c020,0x00000000,0x00000000,unsigned>;
    ...
    namespace I2c2Msttime{    ///<Master timing configuration.
        using Addr = Register::Address<0x4009c024,0x00000000,0x00000000,unsigned>;
    ...
    namespace I2c2Mstdat{    ///<Combined Master receiver and transmitter data                        register.
        using Addr = Register::Address<0x4009c028,0x00000000,0x00000000,unsigned>;
    ...
    namespace I2c2Slvctl{    ///<Slave control register.
        using Addr = Register::Address<0x4009c040,0x00000004,0x00000000,unsigned>;
        ///Slave Continue.
    ...
    namespace I2c2Slvdat{    ///<Combined Slave receiver and transmitter data                        register.
        using Addr = Register::Address<0x4009c044,0x00000000,0x00000000,unsigned>;
    ...
    namespace I2c2Slvqual0{    ///<Slave Qualification for address 0.
        using Addr = Register::Address<0x4009c058,0x00000000,0x00000000,unsigned>;
    ...
    namespace I2c2Monrxdat{    ///<Monitor receiver data register.
        using Addr = Register::Address<0x4009c080,0x00000000,0x00000000,unsigned>;
    ...
    namespace I2c2Slvadr0{    ///<Slave address 0.
        using Addr = Register::Address<0x4009c048,0x00000000,0x00000000,unsigned>;
    ...
    namespace I2c2Slvadr1{    ///<Slave address 0.
        using Addr = Register::Address<0x4009c04c,0x00000000,0x00000000,unsigned>;
        ///Slave Address n Disable.
        enum class SadisableVal {
            enabled=0x00000000,     ///<Enabled. Slave Address n is enabled.
            ignoredSlaveAddres=0x00000001,     ///<Ignored Slave Address n is ignored.
    ...
    namespace I2c2Slvadr2{    ///<Slave address 0.
        using Addr = Register::Address<0x4009c050,0x00000000,0x00000000,unsigned>;
        ///Slave Address n Disable.
        enum class SadisableVal {
            enabled=0x00000000,     ///<Enabled. Slave Address n is enabled.
            ignoredSlaveAddres=0x00000001,     ///<Ignored Slave Address n is ignored.
    ...
    namespace I2c2Slvadr3{    ///<Slave address 0.
        using Addr = Register::Address<0x4009c054,0x00000000,0x00000000,unsigned>;
        ///Slave Address n Disable.
        enum class SadisableVal {
            enabled=0x00000000,     ///<Enabled. Slave Address n is enabled.
            ignoredSlaveAddres=0x00000001,     ///<Ignored Slave Address n is ignored.
