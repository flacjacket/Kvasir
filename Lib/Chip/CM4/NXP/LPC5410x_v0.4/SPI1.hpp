...
//SPI1
    namespace Spi1Cfg{    ///<SPI Configuration register
        ...
        ///Clock Phase select.
        enum class CphaVal {
            change=0x00000000,     ///<Change. The SPI captures serial data on the first                                        clock transition of the transfer (when the clock changes                                        away from the rest state). Data is changed on the following                                        edge.
            capture=0x00000001,     ///<Capture. The SPI changes serial data on the first                                        clock transition of the transfer (when the clock changes                                        away from the rest state). Data is captured on the following                                        edge.
        };
        ...
        enum class CpolVal {
            low=0x00000000,     ///<Low. The rest state of the clock (between                                        transfers) is low.
            high=0x00000001,     ///<High. The rest state of the clock (between                                        transfers) is high.
        };
    ...
    namespace Spi1Dly{    ///<SPI Delay register
        using Addr = Register::Address<0x400a8004,0x00000000,0x00000000,unsigned>;
    ...
    namespace Spi1Stat{    ///<SPI Status. Some status flags can be cleared by writing a 1 to that                        bit position
        using Addr = Register::Address<0x400a8008,0x00000000,0x00000000,unsigned>;
    ...
    namespace Spi1Intenset{    ///<SPI Interrupt Enable read and Set. A complete value may be read                        from this register. Writing a 1 to any implemented bit position causes that                        bit to be set.
        using Addr = Register::Address<0x400a800c,0x00000000,0x00000000,unsigned>;
        ///RX ready interrupt enable. Determines whether an interrupt                                occurs when receiver data is available.
        enum class RxrdyenVal {
            disabled=0x00000000,     ///<Disabled. No interrupt will be generated when                                        receiver data is available.
            enabled=0x00000001,     ///<Enabled. An interrupt will be generated when                                        receiver data is available in the RXDAT                                        register.
        };
        ...
        ///TX ready interrupt enable. Determines whether an interrupt                                occurs when the transmitter holding register is                                available.
        enum class TxrdyenVal {
            disabled=0x00000000,     ///<Disabled. No interrupt will be generated when the                                        transmitter holding register is available.
            enabled=0x00000001,     ///<Enabled. An interrupt will be generated when data                                        may be written to TXDAT.
        };
        ...
        ///RX overrun interrupt enable. Determines whether an                                interrupt occurs when a receiver overrun occurs. This happens in                                slave mode when there is a need for the receiver to move newly                                received data to the RXDAT register when it is already in use. The                                interface prevents receiver overrun in Master mode by not allowing a                                new transmission to begin when a receiver overrun would otherwise                                occur.
        enum class RxovenVal {
            disabled=0x00000000,     ///<Disabled. No interrupt will be generated when a                                        receiver overrun occurs.
            enabled=0x00000001,     ///<Enabled. An interrupt will be generated if a                                        receiver overrun occurs.
        };
        ...
        enum class TxurenVal {
            disabled=0x00000000,     ///<Disabled. No interrupt will be generated when the                                        transmitter underruns.
            enabled=0x00000001,     ///<Enabled. An interrupt will be generated if the                                        transmitter underruns.
        };
        ...
        enum class SsaenVal {
            disabled=0x00000000,     ///<Disabled. No interrupt will be generated when any                                        Slave Select transitions from deasserted to                                        asserted.
            enabled=0x00000001,     ///<Enabled. An interrupt will be generated when any                                        Slave Select transitions from deasserted to                                        asserted.
        };
        ...
        enum class SsdenVal {
            disabled=0x00000000,     ///<Disabled. No interrupt will be generated when all                                        asserted Slave Selects transition to                                        deasserted.
            enabled=0x00000001,     ///<Enabled. An interrupt will be generated when all                                        asserted Slave Selects transition to                                        deasserted.
        };
        ...
        enum class MstidleenVal {
            disabled=0x00000000,     ///<Disabled. No interrupt will be generated when the                                        SPI master function is idle.
            enabled=0x00000001,     ///<Enabled. An interrupt will be generated when the                                        SPI master function is idle.
        };
    ...
    namespace Spi1Intenclr{    ///<SPI Interrupt Enable Clear. Writing a 1 to any implemented bit                        position causes the corresponding bit in INTENSET to be                        cleared.
        using Addr = Register::Address<0x400a8010,0x00000000,0x00000000,unsigned>;
    ...
    namespace Spi1Rxdat{    ///<SPI Receive Data
        using Addr = Register::Address<0x400a8014,0x00000000,0x00000000,unsigned>;
    ...
    namespace Spi1Txdatctl{    ///<SPI Transmit Data with Control
        using Addr = Register::Address<0x400a8018,0x00000000,0x00000000,unsigned>;
    ...
    namespace Spi1Txdat{    ///<SPI Transmit Data
        using Addr = Register::Address<0x400a801c,0x00000000,0x00000000,unsigned>;
    ...
    namespace Spi1Txctl{    ///<SPI Transmit Control
    ...
    namespace Spi1Div{    ///<SPI clock Divider
    ...
    namespace Spi1Intstat{    ///<SPI Interrupt Status
