...
namespace Kvasir {
//I2C-bus interface 1
    namespace I2c1Cfg{    ///<Configuration for shared functions.
        using Addr = Register::Address<0x40098000,0x00000000,0x00000000,unsigned>;
    ...
    namespace I2c1Stat{    ///<Status register for Master, Slave, and Monitor                        functions.
        using Addr = Register::Address<0x40098004,0x00000000,0x00000000,unsigned>;
    ...
    namespace I2c1Intenset{    ///<Interrupt Enable Set and read register.
        using Addr = Register::Address<0x40098008,0x00000000,0x00000000,unsigned>;
    ...
    namespace I2c1Intenclr{    ///<Interrupt Enable Clear register.
        using Addr = Register::Address<0x4009800c,0x00000000,0x00000000,unsigned>;
    ...
    namespace I2c1Timeout{    ///<Time-out value register.
        using Addr = Register::Address<0x40098010,0x00000000,0x00000000,unsigned>;
    ...
    namespace I2c1Clkdiv{    ///<Clock pre-divider for the entire I2C block. This determines what                        time increments are used for the MSTTIME register, and controls some timing                        of the Slave function.
        using Addr = Register::Address<0x40098014,0x00000000,0x00000000,unsigned>;
    ...
    namespace I2c1Intstat{    ///<Interrupt Status register for Master, Slave, and Monitor                        functions.
        using Addr = Register::Address<0x40098018,0x00000000,0x00000000,unsigned>;
        ///Master Pending.
    ...
    namespace I2c1Mstctl{    ///<Master control register.
        using Addr = Register::Address<0x40098020,0x00000000,0x00000000,unsigned>;
    ...
    namespace I2c1Msttime{    ///<Master timing configuration.
        using Addr = Register::Address<0x40098024,0x00000000,0x00000000,unsigned>;
    ...
    namespace I2c1Mstdat{    ///<Combined Master receiver and transmitter data                        register.
        using Addr = Register::Address<0x40098028,0x00000000,0x00000000,unsigned>;
    ...
    namespace I2c1Slvctl{    ///<Slave control register.
        using Addr = Register::Address<0x40098040,0x00000004,0x00000000,unsigned>;
        ///Slave Continue.
    ...
    namespace I2c1Slvdat{    ///<Combined Slave receiver and transmitter data                        register.
        using Addr = Register::Address<0x40098044,0x00000000,0x00000000,unsigned>;
    ...
    namespace I2c1Slvqual0{    ///<Slave Qualification for address 0.
        using Addr = Register::Address<0x40098058,0x00000000,0x00000000,unsigned>;
    ...
    namespace I2c1Monrxdat{    ///<Monitor receiver data register.
        using Addr = Register::Address<0x40098080,0x00000000,0x00000000,unsigned>;
    ...
    namespace I2c1Slvadr0{    ///<Slave address 0.
        using Addr = Register::Address<0x40098048,0x00000000,0x00000000,unsigned>;
    ...
    namespace I2c1Slvadr1{    ///<Slave address 0.
        using Addr = Register::Address<0x4009804c,0x00000000,0x00000000,unsigned>;
        ///Slave Address n Disable.
        enum class SadisableVal {
            enabled=0x00000000,     ///<Enabled. Slave Address n is enabled.
            ignoredSlaveAddres=0x00000001,     ///<Ignored Slave Address n is ignored.
    ...
    namespace I2c1Slvadr2{    ///<Slave address 0.
        using Addr = Register::Address<0x40098050,0x00000000,0x00000000,unsigned>;
        ///Slave Address n Disable.
        enum class SadisableVal {
            enabled=0x00000000,     ///<Enabled. Slave Address n is enabled.
            ignoredSlaveAddres=0x00000001,     ///<Ignored Slave Address n is ignored.
    ...
    namespace I2c1Slvadr3{    ///<Slave address 0.
        using Addr = Register::Address<0x40098054,0x00000000,0x00000000,unsigned>;
        ///Slave Address n Disable.
        enum class SadisableVal {
            enabled=0x00000000,     ///<Enabled. Slave Address n is enabled.
            ignoredSlaveAddres=0x00000001,     ///<Ignored Slave Address n is ignored.
