...
//USART1
    namespace Usart1Cfg{    ///<USART Configuration register. Basic USART configuration settings                        that typically are not changed during operation.
        using Addr = Register::Address<0x40088000,0x00000000,0x00000000,unsigned>;
        ///USART Enable.
    ...
    namespace Usart1Ctl{    ///<USART Control register. USART control settings that are more likely                        to change during operation.
        using Addr = Register::Address<0x40088004,0x00000000,0x00000000,unsigned>;
        ///Reserved. Read value is undefined, only zero should be                                written.
    ...
    namespace Usart1Stat{    ///<USART Status register. The complete status value can be read here.                        Writing ones clears some bits in the register. Some bits can be cleared by                        writing a 1 to them.
        using Addr = Register::Address<0x40088008,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usart1Intenset{    ///<Interrupt Enable read and Set register. Contains an individual                        interrupt enable bit for each potential USART interrupt. A complete value                        may be read from this register. Writing a 1 to any implemented bit position                        causes that bit to be set.
        using Addr = Register::Address<0x4008800c,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usart1Intenclr{    ///<Interrupt Enable Clear register. Allows clearing any combination of                        bits in the INTENSET register. Writing a 1 to any implemented bit position                        causes the corresponding bit to be cleared.
        using Addr = Register::Address<0x40088010,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usart1Rxdat{    ///<Receiver Data register. Contains the last character                        received.
        using Addr = Register::Address<0x40088014,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usart1Rxdatstat{    ///<Receiver Data with Status register. Combines the last character                        received with the current USART receive status. Allows DMA or software to                        recover incoming data and status together.
        using Addr = Register::Address<0x40088018,0x00000000,0x00000000,unsigned>;
        ///The USART Receiver Data register contains the next received                                character. The number of bits that are relevant depends on the USART                                configuration settings.
    ...
    namespace Usart1Txdat{    ///<Transmit Data register. Data to be transmitted is written                        here.
    ...
    namespace Usart1Intstat{    ///<Interrupt status register. Reflects interrupts that are currently                        enabled.
        using Addr = Register::Address<0x40088024,0x00000000,0x00000000,unsigned>;
        ///Receiver Ready flag.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> rxrdy{}; 
        ///Reserved. Read value is undefined, only zero should be                                written.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> reserved{}; 
    ...
    namespace Usart1Osr{    ///<Oversample selection register for asynchronous                        communication.
        using Addr = Register::Address<0x40088028,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usart1Addr{    ///<Address register for automatic address matching.
        using Addr = Register::Address<0x4008802c,0x00000000,0x00000000,unsigned>;
